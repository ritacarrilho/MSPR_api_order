...
| `test_insert_into_orders` | Teste l'insertion d'une commande dans la table 'orders'. | Unitaire |
| `test_insert_into_order_products` | Teste l'insertion d'un produit dans la table 'order_products'. | Unitaire |
| `test_read_from_orders` | Teste la lecture des données insérées dans la table 'orders'. | Unitaire |
| `test_update_orders` | Teste la mise à jour d'une commande dans la table 'orders'. | Unitaire |
| `test_delete_from_orders` | Teste la suppression d'une commande dans la table 'orders'. | Unitaire |
| `test_read_from_order_products` | Teste la lecture des données insérées dans la table 'order_products'. | Unitaire |
