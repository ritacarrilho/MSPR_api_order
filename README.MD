...
- `test_get_orders` teste la récupération des commandes.

- `test_update_order` teste la mise à jour d'une commande.

- `test_delete_order` teste la suppression d'une commande.
